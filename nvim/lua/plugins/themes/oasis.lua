...
return {
  ...
  lazy = false,
  config = function()
    -- local c = require("oasis.color_palettes.oasis_dune").dark
    ...
    local opts = {
      ...
      highlight_overrides = {
        ...
        --
        -- -- MatchParenCur = { bg = c.ui.search.bg, bold = true },
        -- -- MatchWord = { bg = c.ui.search.bg },
        -- -- MatchWordCur = { bg = c.ui.search.bg },
        --
        ...
        -- SnacksPickerDir = { fg = c.fg.muted, italic = true },
        ...
        -- --
        -- BlinkCmpMenu = { bg = bg_core, fg = c.fg.dim },
        ...
        -- BlinkCmpLabelMatch = { fg = c.ui.match.bg, bold = true, underline = false },
        -- BlinkCmpMenuSelection = { fg = c.ui.match.fg, bg = palette.visual.bright_yellow },
        ...
        --
        -- Type = { fg = palette.sunshine[600], bold = true },
        -- ["@tag.tsx"] = { bold = true },
        -- ["@tag.jsx"] = { bold = true },
        -- ["@punctuation.bracket"] = { fg = palette.grey[800], bold = false },
        -- Function = { fg = palette.sky[600] },
        -- ["@module"] = { fg = palette.peach[800], bold = false, italic = true },
        -- ["@operator"] = { fg = palette.peach[800] },
        -- ["@parameter"] = { fg = palette.lavender[400] },
        -- ["@variable.parameter"] = "@parameter",
        -- ["@type.builtin"] = { fg = palette.coral[700] },
        ...
        -- ["@keyword.return"] = { fg = c.syntax.special, bold = true },
        -- --
        -- ["@lsp.type.keyword"] = "Keyword",
        -- ["@lsp.type.modifier"] = "@keyword.modifier",
        -- ["@lsp.type.interface"] = { fg = palette.sunset[700], bold = true, italic = false },
        -- ["@lsp.type.namespace"] = "@module",
        -- ["@lsp.type.enum"] = { fg = palette.cyan[700], bold = true, italic = false },
        ...
        SnacksIndentScopeRed = "RainbowDelimiterRed",
        SnacksIndentScopeOrange = "RainbowDelimiterOrange",
        SnacksIndentScopeYellow = "RainbowDelimiterYellow",
        SnacksIndentScopeGreen = "RainbowDelimiterGreen",
        SnacksIndentScopeCyan = "RainbowDelimiterCyan",
        SnacksIndentScopeBlue = "RainbowDelimiterBlue",
        SnacksIndentScopeViolet = "RainbowDelimiterViolet",
