      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        callback = function(args)
          ...
          if client and client.name == "jdtls" then
            ...
            local mason_registry2 = require("mason-registry")
            if opts.dap and mason_registry2.is_installed("java-debug-adapter") then
              ...
              if opts.test and mason_registry2.is_installed("java-test") then
