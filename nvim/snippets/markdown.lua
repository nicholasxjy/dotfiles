...
return {
  ...
  s({ trig = "~", wordTrig = false }, fmt([[\sim]], {}), { condition = in_mathzone }),
  ...
  s({ trig = "\\sim~", wordTrig = false, priority = 1001 }, fmt([[\approx]], {}), { condition = in_mathzone }),
  ...
  s({ trig = "<-", wordTrig = false }, fmt([[\longleftarrow]], {}), { condition = in_mathzone }),
  ...
  s({ trig = "mid", wordTrig = false }, fmt([[\mid]], {}), { condition = in_mathzone_ignore_backslash }),
  s(
  ...
  s({ trig = "sim" }, fmt([[\sim]], {}), { condition = in_mathzone_ignore_backslash }),
  s({ trig = "approx" }, fmt([[\approx]], {}), { condition = in_mathzone_ignore_backslash }),
  s({ trig = "int" }, fmt([[\int]], {}), { condition = in_mathzone_ignore_backslash }),
  s({ trig = "vert" }, fmt([[\vert]], {}), { condition = in_mathzone_ignore_backslash }),
  ...
  s({ trig = "\\?text", regTrig = true }, fmt([[\text{{{}}}]], { i(1, "") }), { condition = in_mathzone }),
